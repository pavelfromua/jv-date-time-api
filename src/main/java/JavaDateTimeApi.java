...
public class JavaDateTimeApi {
    ...
    public Optional<LocalDate> getDate(Integer[] dateParams) {
        ...
        try {
            optional = Optional.of(LocalDate.of(dateParams[0], dateParams[1], dateParams[2]));
        } catch (Exception e) {
    ...
    public String beforeOrAfter(LocalDate someDate) {
        ...
        return someDate.isBefore(thisDay) ? someDate + " is before " + thisDay
                : someDate.isAfter(thisDay) ? someDate + " is after " + thisDay
                : someDate + " is today";
    }
    ...
    public Optional<LocalDate> parseDate(String date) {
        ...
        try {
            thisDate = Optional.of(LocalDate.parse(date, DateTimeFormatter.ofPattern("yyyyMMdd")));
        } catch (Exception e) {
